    ...
    <div class="py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('gapoktan.show', $gapoktan->id) }}">{{ $gapoktan->nama }}</a></li>
    ...
    <div class="row">
        <div class="col-12 mb-4">
            <div class="card border-light shadow-sm components-section">
                <div class="card-body">
                    <p><a href="{{ route('gapoktan.show', $gapoktan->id) }}" class="btn btn-primary">&lt;&lt; Kembali ke Detail Gapoktan</a></p>
                    <div class="row">
                        <div class="col-md-8"></div>
                        <div class="col-md-4">
                            <a href="{{ route('ketua.poktan.create') }}" class="btn btn-primary btn-sm float-right mb-3">Tambah Poktan</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($poktan as $index => $data)
                                <tr>
                                    ...
                                    <td>{{ $data->nama }}</td>
                                    <td>
                                        <a href="{{ route('ketua.poktan.show', $data->id) }}" class="btn btn-info btn-sm">Detail</a>
                                        <a href="{{ route('ketua.poktan.edit', $data->id) }}" class="btn btn-primary btn-sm">Edit</a>
