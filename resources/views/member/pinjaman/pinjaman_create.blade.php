                    ...
                    <div class="col-lg-4 col-sm-6">
                        <form action="{{ route('pinjaman.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control {{ $errors->first('jangka_waktu') ? 'is-invalid' : '' }}" id="jangka_waktu" name="jangka_waktu" value="{{ $data_pengaturan ? $data_pengaturan->waktu_pinjaman : '' }}" autocomplete="off">
                                <div class="invalid-feedback">
